...
# Generated by qmake (2.01a) (Qt 4.7.1) on: ? 2? 2 18:31:37 2011
# Project:  Imazer.pro
# Template: app
...
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -I. -I. -I. -I/opt/local/include/QtGui -I/opt/local/include/QtCore -I/opt/local/include -I/Users/hiramoto/nao_sdk/include
LINK          = $(CCACHE) /usr/bin/g++-4.0
LFLAGS        = -headerpad_max_install_names
LIBS          = $(SUBLIBS)   -L/opt/local/lib -lQtGui -lQtCore -L/Users/hiramoto/nao_sdk/lib -lalcore -lalcommon -lnaoqiclient
AR            = ar cq
RANLIB        = ranlib -s
...
SOURCES       = ImageWidget.cpp \
		Main.cpp \
		MainWindow.cpp \
		CentralWidget.cpp moc_ImageWidget.cpp \
		moc_MainWindow.cpp \
		moc_CentralWidget.cpp
OBJECTS       = ImageWidget.o \
		Main.o \
		MainWindow.o \
		CentralWidget.o \
		moc_ImageWidget.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Imazer1.0.0/ && $(COPY_FILE) --parents ImageWidget.h MainWindow.h CentralWidget.h .tmp/Imazer1.0.0/ && $(COPY_FILE) --parents ImageWidget.cpp Main.cpp MainWindow.cpp CentralWidget.cpp .tmp/Imazer1.0.0/ && (cd `dirname .tmp/Imazer1.0.0` && $(TAR) Imazer1.0.0.tar Imazer1.0.0 && $(COMPRESS) Imazer1.0.0.tar) && $(MOVE) `dirname .tmp/Imazer1.0.0`/Imazer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Imazer1.0.0
...
compiler_moc_header_make_all: moc_ImageWidget.cpp moc_MainWindow.cpp moc_CentralWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_ImageWidget.cpp moc_MainWindow.cpp moc_CentralWidget.cpp
moc_ImageWidget.cpp: ImageWidget.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ ImageWidget.h -o moc_ImageWidget.cpp
...
moc_CentralWidget.cpp: ImageWidget.h \
		CentralWidget.h
	/opt/local/bin/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ CentralWidget.h -o moc_CentralWidget.cpp
...
CentralWidget.o: CentralWidget.cpp 
