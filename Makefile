...
# Generated by qmake (2.01a) (Qt 4.7.1) on: ? 2? 6 16:01:27 2011
# Project:  Imazer.pro
# Template: app
...
INCPATH       = -I/opt/local/share/qt4/mkspecs/macx-g++ -I. -I. -I. -I/opt/local/include/QtGui -I/opt/local/include/QtCore -I/opt/local/include -I$(AL_DIR)/include
...
SOURCES       = CentralWidget.cpp \
		ImageWidget.cpp \
		Main.cpp \
		MainWindow.cpp moc_CentralWidget.cpp \
		moc_ImageWidget.cpp \
		moc_MainWindow.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Imazer1.0.0/ && $(COPY_FILE) --parents CentralWidget.h ImageWidget.h MainWindow.h .tmp/Imazer1.0.0/ && $(COPY_FILE) --parents CentralWidget.cpp ImageWidget.cpp Main.cpp MainWindow.cpp .tmp/Imazer1.0.0/ && (cd `dirname .tmp/Imazer1.0.0` && $(TAR) Imazer1.0.0.tar Imazer1.0.0 && $(COMPRESS) Imazer1.0.0.tar) && $(MOVE) `dirname .tmp/Imazer1.0.0`/Imazer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Imazer1.0.0
